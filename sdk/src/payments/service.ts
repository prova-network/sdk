import { asChain } from '@prova-network/core/chains'
import * as ERC20 from '@prova-network/core/erc20'
import * as Pay from '@prova-network/core/pay'
import {
  type Account,
  type Address,
  type Chain,
...
export class PaymentsService {
   ...
   * const hash = await prova.payments.settleAuto({ railId })
   *
   * // For active rails, can specify epoch
   * const hash = await prova.payments.settleAuto({ railId, untilEpoch: specificEpoch })
   * ```
   */
