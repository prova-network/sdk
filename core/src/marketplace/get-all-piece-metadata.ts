...
export namespace getAllPieceMetadata {
  export type OptionsType = {
    ...
    pieceId: bigint
    /** FilecoinStorage contract address. If not provided, the default is the storage view contract address for the chain. */
 ...
 * @example
 * ```ts
 * import { getAllPieceMetadata } from '@prova-network/core/storage'
 ...
 * @example
 * ```ts
 * import { parseAllPieceMetadata, getAllPieceMetadataCall } from '@prova-network/core/storage'
 * import { createPublicClient, http } from 'viem'
