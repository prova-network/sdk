 ...
 * @example
 * ```ts
 * import { addApprovedProvider } from '@prova-network/core/storage'
 ...
 * @example
 * ```ts
 * import { addApprovedProviderSync } from '@prova-network/core/storage'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { addApprovedProviderCall } from '@prova-network/core/storage'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
