 ...
 * @example
 * ```ts
 * import { terminateService } from '@prova-network/core/storage'
 ...
 * @example
 * ```ts
 * import { terminateServiceSync } from '@prova-network/core/storage'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { terminateServiceCall } from '@prova-network/core/storage'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
