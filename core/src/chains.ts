 ...
 * @example
 * ```ts
 * import * as Chains from '@prova-network/core/chains'
 * ```
 *
 * @module chains
 */
...
export const mainnet: Chain = {
  ...
  contracts: {
    ...
    fwss: {
      address: Abis.generated.filecoinStorageServiceAddress['314'],
      abi: Abis.fwss,
    },
    fwssView: {
      address: Abis.generated.filecoinStorageServiceStateViewAddress['314'],
      abi: Abis.fwssView,
    },
    serviceProviderRegistry: {
...
export const calibration: Chain = {
  ...
  contracts: {
    ...
    fwss: {
      address: Abis.generated.filecoinStorageServiceAddress['314159'],
      abi: Abis.fwss,
    },
    fwssView: {
      address: Abis.generated.filecoinStorageServiceStateViewAddress['314159'],
      abi: Abis.fwssView,
    },
    serviceProviderRegistry: {
...
/**
 * Convert a viem client to a prova client.
 * @param client - The viem client.
 * @returns The prova client.
 */
