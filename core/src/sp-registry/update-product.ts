 ...
 * @example
 * ```ts
 * import { updateProduct } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { updateProductSync } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http, parseEther } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { updateProductCall } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http, parseEther } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
