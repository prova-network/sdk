 ...
 * @example
 * ```ts
 * import { addProduct } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { addProductSync } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http, parseEther } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { addProductCall } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http, parseEther } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
