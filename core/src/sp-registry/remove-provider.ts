 ...
 * @example
 * ```ts
 * import { removeProvider } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { removeProviderSync } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { removeProviderCall } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
