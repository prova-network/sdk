...
import { getApprovedProviderIdsCall } from '../storage/get-approved-provider-ids.ts'
 ...
 * @example
 * ```ts
 * import { getPDPProviders } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { getPDPProvidersCall } from '@prova-network/core/sp-registry'
 * import { createPublicClient, http } from 'viem'
...
/**
 * Get FilecoinStorage approved PDP providers
 *
 * @param client - The client to use to get the providers.
 ...
 * @example
 * ```ts
 * import { getPDPProvidersByIds } from '@prova-network/core/sp-registry'
 * import { createPublicClient, http } from 'viem'
 * import { calibration } from '@prova-network/core/chains'
 *
 * const client = createPublicClient({
