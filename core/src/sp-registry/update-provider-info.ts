 ...
 * @example
 * ```ts
 * import { updateProviderInfo } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { updateProviderInfoSync } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { updateProviderInfoCall } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
