 ...
 * @example
 * ```ts
 * import { registerProvider } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { registerProviderSync } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http, parseEther } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { registerProviderCall } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http, parseEther } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { simulateContract } from 'viem/actions'
 * import { calibration } from '@prova-network/core/chains'
 * import { encodePDPCapabilities } from '@prova-network/core/utils/pdp-capabilities'
 *
 * const account = privateKeyToAccount('0x...')
 * const client = createWalletClient({
 *   account,
