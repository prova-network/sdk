 ...
 * @example
 * ```ts
 * import { removeProduct } from '@prova-network/core/sp-registry'
 ...
 * @example
 * ```ts
 * import { removeProductSync } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { removeProductCall } from '@prova-network/core/sp-registry'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
