...
export class LocationHeaderError extends ProvaError {
  ...
  static override is(value: unknown): value is LocationHeaderError {
    return isProvaError(value) && value.name === 'LocationHeaderError'
  }
}

export class CreateDataSetError extends ProvaError {
  ...
  static override is(value: unknown): value is CreateDataSetError {
    return isProvaError(value) && value.name === 'CreateDataSetError'
  }
}

export class WaitForCreateDataSetError extends ProvaError {
  ...
  static override is(value: unknown): value is WaitForCreateDataSetError {
    return isProvaError(value) && value.name === 'WaitForCreateDataSetError'
  }
}

export class WaitForCreateDataSetRejectedError extends ProvaError {
...
export class GetDataSetError extends ProvaError {
  ...
  static override is(value: unknown): value is GetDataSetError {
    return isProvaError(value) && value.name === 'GetDataSetError'
  }
}

export class PostPieceError extends ProvaError {
  ...
  static override is(value: unknown): value is PostPieceError {
    return isProvaError(value) && value.name === 'PostPieceError'
  }
}

export class UploadPieceError extends ProvaError {
  ...
  static override is(value: unknown): value is UploadPieceError {
    return isProvaError(value) && value.name === 'UploadPieceError'
  }
}

export class FindPieceError extends ProvaError {
  ...
  static override is(value: unknown): value is FindPieceError {
    return isProvaError(value) && value.name === 'FindPieceError'
  }
}

export class AddPiecesError extends ProvaError {
  ...
  static override is(value: unknown): value is AddPiecesError {
    return isProvaError(value) && value.name === 'AddPiecesError'
  }
}

export class WaitForAddPiecesError extends ProvaError {
  ...
  static override is(value: unknown): value is WaitForAddPiecesError {
    return isProvaError(value) && value.name === 'WaitForAddPiecesError'
  }
}

export class WaitForAddPiecesRejectedError extends ProvaError {
  ...
  static override is(value: unknown): value is WaitForAddPiecesRejectedError {
    return isProvaError(value) && value.name === 'WaitForAddPiecesRejectedError'
  }
}

export class DeletePieceError extends ProvaError {
  ...
  static override is(value: unknown): value is DeletePieceError {
    return isProvaError(value) && value.name === 'DeletePieceError'
  }
}

export class InvalidUploadSizeError extends ProvaError {
  ...
  static override is(value: unknown): value is InvalidUploadSizeError {
    return isProvaError(value) && value.name === 'InvalidUploadSizeError'
  }
}

export class DownloadPieceError extends ProvaError {
  ...
  static override is(value: unknown): value is DownloadPieceError {
    return isProvaError(value) && value.name === 'DownloadPieceError'
  }
}
