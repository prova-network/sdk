 ...
 */
export const filecoinStorageServiceAbi = [
  {
    type: 'constructor',
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'plannedUpgrade',
        internalType: 'struct FilecoinStorageService.PlannedUpgrade',
        type: 'tuple',
        components: [
          {
  ...
  },
  {
    ...
    outputs: [
      {
        name: 'pricing',
        internalType: 'struct FilecoinStorageService.ServicePricing',
        type: 'tuple',
        components: [
          {
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x02925630df557F957f70E112bA06e50965417CA0)
 */
export const filecoinStorageServiceAddress = {
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x02925630df557F957f70E112bA06e50965417CA0)
 */
export const filecoinStorageServiceConfig = {
  address: filecoinStorageServiceAddress,
  abi: filecoinStorageServiceAbi,
} as const

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// FilecoinStorageServiceStateView
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 */
export const filecoinStorageServiceStateViewAbi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: '_service',
        internalType: 'contract FilecoinStorageService',
        type: 'address',
      },
    ],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      {
        name: 'infos',
        internalType: 'struct FilecoinStorageService.DataSetInfoView[]',
        type: 'tuple[]',
        components: [
  ...
  },
  {
    ...
    outputs: [
      {
        name: 'status',
        internalType: 'enum FilecoinStorageService.DataSetStatus',
        type: 'uint8',
      },
    ],
    stateMutability: 'view',
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x537320bd004a7FDd3c1932ca64BD88268301322A)
 */
export const filecoinStorageServiceStateViewAddress = {
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x537320bd004a7FDd3c1932ca64BD88268301322A)
 */
export const filecoinStorageServiceStateViewConfig = {
  address: filecoinStorageServiceStateViewAddress,
  abi: filecoinStorageServiceStateViewAbi,
} as const
