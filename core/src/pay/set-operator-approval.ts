 ...
 * @example
 * ```ts
 * import { setOperatorApproval } from '@prova-network/core/pay'
 ...
 * @example
 * ```ts
 * import { setOperatorApprovalSync } from '@prova-network/core/pay'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { setOperatorApprovalCall } from '@prova-network/core/pay'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
