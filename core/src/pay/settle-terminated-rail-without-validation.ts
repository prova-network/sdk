 ...
 * @example
 * ```ts
 * import { settleTerminatedRailWithoutValidation } from '@prova-network/core/pay'
 ...
 * @example
 * ```ts
 * import { settleTerminatedRailWithoutValidationSync } from '@prova-network/core/pay'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
 * import { calibration } from '@prova-network/core/chains'
 *
 ...
 * @example
 * ```ts
 * import { settleTerminatedRailWithoutValidationCall } from '@prova-network/core/pay'
 * import { createWalletClient, http } from 'viem'
 * import { privateKeyToAccount } from 'viem/accounts'
